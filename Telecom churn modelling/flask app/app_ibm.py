...
API_KEY = "rNbGY8Lq1lwnQTrfQtYomxlznSCS1Hd026MF0uRUCMnr"
...
def admin():
    ...
    payload_scoring = {"input_data": [{"fields": [['g','h','i','j','k','l','m','n','o','p','a','b','c','d','e','f','q','r','s']], "values": t }]}
    
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/68bcfbe4-f68e-4e05-b6eb-932d950b5a36/predictions?version=2022-04-02', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
